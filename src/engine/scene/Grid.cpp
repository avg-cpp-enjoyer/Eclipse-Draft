...
void Grid::Draw(ID3D11DeviceContext* context, const Camera& camera) const {
	...
	ID3D11Buffer* gridBuf = BufferManager::GetBuffer<GridParams>();
	ID3D11Buffer* camBuf = BufferManager::GetBuffer<CameraParams>();
	ID3D11Buffer* transformBuf = BufferManager::GetBuffer<TransformBuffer>();
