...
void StaticMesh::SetPosition(const DirectX::XMFLOAT3& pos) {
	m_position = pos;
}

void StaticMesh::SetRotation(const DirectX::XMFLOAT3& rotation) {
	m_rotation = rotation;
}

void StaticMesh::SetScale(const DirectX::XMFLOAT3& scale) {
	m_scale = scale;
}

void StaticMesh::SetVertices(const std::vector<Vertex>& vertices) {
	m_vertices = vertices;
}
...
const std::vector<Vertex>& StaticMesh::Vertices() {
	return m_vertices;
}

const std::vector<uint32_t>& StaticMesh::Indices() {
	return m_indices;
}
